...
def show_user_data(request):
    ...
    data2 = User.objects.filter(email='tahsin@gmail.com')
    data3 = User.objects.filter(mypage__page_cat='Programming')
    data4 = User.objects.filter(mypost__post_publish_date='2024-04-24')
...
def show_page_data(request):
    ...
    data3 = Page.objects.filter(user__email='tahsin@gmail.com')
...
def show_post_data(request):
    ...
    data2 = Post.objects.filter(post_publish_date='2024-04-24')
...
def show_song_data(request):
    ...
    data3 = Song.objects.filter(user__username='tahsin')
